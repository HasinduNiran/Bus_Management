...
function CreateBusOwner() {
  ...
  const handleSaveBusOwner=()=>{
    ...
    setLoading(true);
    axios
    .post('http://localhost:8077/BusOwner',data)
    .then(()=>{
        setLoading(false);
        navigate('/');
    })
  ...
  return (
    <div className='p-4'>
      <BackButton/>
      <h1 className='text-3xl my-4'>Create BusOwner</h1>
      {loading ? <Spinner/>:''}
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <button className='p-2 bg-sky-300 m-8 'onClick={handleSaveBusOwner} >
          Save
        </button>
      </div>
    </div>
